...
describe('app.resource(name)', function(){
  it('should return a pre-defined resource', function(){
    ...
    app.resource('users').should.be.an.instanceof(expressResource.Resource);
    app.resource('foo').should.be.an.instanceof(expressResource.Resource);
  })
})
...
describe('app.resource()', function(){
  it('should map CRUD actions', function(done){
    ...
    ret.should.be.an.instanceof(expressResource.Resource);
